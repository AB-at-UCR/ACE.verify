"""Frozen copy of the pre-enhancement architecture.

Kept so that ablations and metric-delta comparisons can instantiate the old model
side by side with the enhanced one. Do not add features here.
"""
...
class ACEVerifyBaseline(nn.Module):
    def __init__(self):
        super().__init__()
    ...
    def forward(self, video, audio_spec=None, return_aux: bool = False):
        ...
        if return_aux:
            return logits, {"embedding": fused_features, "patch_logits": None}
        return logits
